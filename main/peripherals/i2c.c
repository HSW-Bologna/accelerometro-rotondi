...
static inline void __attribute__((always_inline)) i2c_clock_tick(unsigned char ck) {
    HAP_CLK_LAT = ck;
...
int i2c_port_transfer(uint8_t devaddr, uint8_t *writebuf, size_t writelen, uint8_t *readbuf, size_t readlen,
                                  void *arg) {
